...
export const MoviePage = () => {
  ...
  console.log( `Top of movie page member_id=${localStorage.getItem('user')}`, typeof(localStorage.getItem('user')))

  // const [user] = useState(80)
  ...
  // console.log(`moviePage user=${user}, typeof(user)=${typeof(user)}, typeof(localStorage.get(user))=${typeof(localStorage.getItem('user'))}`)
  ...
  return (
    <div>
      ...
      <div style={{ backgroundColor: 'darkblue', height: '150px', color: "gold" }}>
